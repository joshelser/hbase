...
public interface MetricsRegionServerQuotaSource extends BaseSource {
  ...
  String NUM_REGION_SIZE_REPORT_DESC = "The number of region size reports sent to the Master";
  String REGION_SIZE_REPORTING_CHORE_TIME_NAME = "regionSizeReportingChoreTime";
  String REGION_SIZE_REPORTING_CHORE_TIME_DESC =
      "The amount of time spent in the RegionSizeReportingChore";
