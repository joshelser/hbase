...
public class TestSecureRESTServer {
  ...
  public static void setupServer() throws Exception {
    ...
    MyGroupsProvider.mapping.put("rest", Collections.singletonList("users"));
    MyGroupsProvider.mapping.put("hbase", Collections.singletonList("users"));
    MyGroupsProvider.mapping.put("client", Collections.singletonList("users"));
    ...
    conf.set("hadoop.proxyuser.rest.groups", "*");
    UserGroupInformation.setConfiguration(conf);
