 ...
 */
public interface RegionSizeStore extends Iterable<Entry<HRegionInfo,RegionSize>>, HeapSize {
   ...
   */
  RegionSize getRegionSize(HRegionInfo regionInfo);
   ...
   */
  void put(HRegionInfo regionInfo, long size);
   ...
   */
  void incrementRegionSize(HRegionInfo regionInfo, long delta);
   ...
   */
  RegionSize remove(HRegionInfo regionInfo);
