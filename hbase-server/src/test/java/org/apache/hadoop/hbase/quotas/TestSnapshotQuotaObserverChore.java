...
public class TestSnapshotQuotaObserverChore {
  ...
  public void testSnapshotSize() throws Exception {
    ...
    assertEquals(0L, size.longValue());
    ...
    assertEquals(lastSeenSize.get().longValue(), size.longValue());
  }
    ...
    FileArchiverNotifierFactory test = new FileArchiverNotifierFactory() {
      ...
      public FileArchiverNotifier get(
        ...
        return new FileArchiverNotifier() {
          @Override public void addArchivedFiles(Map<String,Long> fileSizes) throws IOException {}
          @Override public Set<String> getRecentlyArchivedFiles() { return null; }
