...
class ScannerCallableWithReplicas implements RetryingCallable<ScanResultWithContext> {
  ...
  private void updateCurrentlyServingReplica(ScannerCallable scanner,
      ScanResultWithContext resultWithContext, AtomicBoolean done, ExecutorService pool) {
  ...
  class RetryingRPC implements RetryingCallable<Pair<ScanResultWithContext,ScannerCallable>>,
      Cancellable {
