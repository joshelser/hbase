 ...
 *   <tr><td>n.&lt;namespace&gt;</td><td>u:s</td><td>&lt:SpaceQuotaSnapshot&gt;</td><td>The size of all snapshots against tables in the namespace</td></tr>
 *   <tr><td>t.&lt;table&gt;</td><td>q:s</td><td>&lt;global-quotas&gt;</td></tr>
 *   <tr><td>t.&lt;table&gt;</td><td>u:p</td><td>&lt;table-quota policy&gt;</td></tr>
 *   <tr><td>t.&lt;table&gt;</td><td>u:s.&lt;snapshot name&gt;</td><td>&lt;SpaceQuotaSnapshot&gt;</td><td>The size of a snapshot against a table</td></tr>
...
public class QuotaTableUtil {
   ...
   */
  public static Put createPutNamespaceSnapshotSize(String namespace, long size) {
  ...
  public static long getNamespaceSnapshotSize(
    ...
    try (Table quotaTable = conn.getTable(QuotaTableUtil.QUOTA_TABLE_NAME)) {
      ...
      Cell c = r.current();
      try {
        return parseSnapshotSize(c);
      } catch (InvalidProtocolBufferException e) {
        LOG.warn("Could not parse snapshot size value for namespace " + namespace, e);
        return 0L;
      }
    }
  }
   ...
   */
  public static long parseSnapshotSize(Cell c) throws InvalidProtocolBufferException {
